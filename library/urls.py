...
from . import views
from .views import BookListView, BookCreateView, BookDetailView, BookUpdateView, BookDeleteView, AuthorUpdateView, AuthorCreateView, AuthorListView, RecommendBookView, ReviewBookView
